...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--auto-target", action="store_true", help="Auto tune target ratio based on real-time ratio")
    parser.add_argument("--min-duration-s", type=float, default=None, help="Loop video until duration reached (test)")
    parser.add_argument("--warmup-s", type=float, default=0.5, help="Warmup seconds to skip in test metrics")
    ...
    parser.add_argument("--imgsz", type=int, help="Inference image size for all detectors")
    ...
    parser.set_defaults(enable_b=None, enable_c=None, enable_d=None, enable_e=None, allow_network=False)
    return parser
